...
{
    /*
     * Compute the set given by IN_SET_FN in a SLICE of the whole
     * domain.  The total number of slices is given by NSLICE.
     *
...
int main(int argc, char** argv)
{
    ...
    /* Set fp to point to the correct function
     * (point_in_mandelbrot_set or point_in_julia_set) */
